...
describe("shouldStageArchiveConfirmation", () => {
  it.each([
    { required: false, confirming: false, expected: false },
    { required: true, confirming: false, expected: true },
    { required: true, confirming: true, expected: false },
  ])("required=$required confirming=$confirming", ({ required, confirming, expected }) => {
    expect(shouldStageArchiveConfirmation(required, confirming)).toBe(expected);
  });
});
