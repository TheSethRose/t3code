...
describe("deriveLockedProvider", () => {
  it("keeps live threads on their provider and unlocks settled boundaries", () => {
...
describe("getStartedThreadModelChangeBlockReason", () => {
  ...
  it("allows provider changes on a settled thread boundary", () => {
    expect(
      getStartedThreadModelChangeBlockReason({
        providers,
        hasStartedSession: true,
  ...
  it("still blocks same-provider model changes on a settled thread", () => {
    expect(
      getStartedThreadModelChangeBlockReason({
        providers,
        hasStartedSession: true,
