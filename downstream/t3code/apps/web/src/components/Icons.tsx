...
export const AcpAgentIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 800 800" className={cn("fill-none", className)}>
    <rect width="800" height="800" rx="160" fill="#1a1a2e" />
    <circle cx="300" cy="400" r="80" fill="#e94560" />
    <circle cx="500" cy="400" r="80" fill="#0f3460" />
    <path fill="#e94560" d="M370 380h60v40h-60z" />
    <circle cx="300" cy="300" r="30" fill="#e94560" opacity="0.6" />
    <circle cx="500" cy="500" r="30" fill="#0f3460" opacity="0.6" />
  </svg>
);
