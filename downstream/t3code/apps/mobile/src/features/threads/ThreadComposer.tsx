...
import { canSwitchProviderBetweenTurns } from "@t3tools/client-runtime/state/thread-settled";
import type {
  EnvironmentId,
  MessageId,
  ModelSelection,
...
export const ThreadComposer = memo(function ThreadComposer(props: ThreadComposerProps) {
  ...
  const threadIdle = canSwitchProviderBetweenTurns(props.selectedThread, {
  ...
  const threadProviderGroups = useMemo(
    ...
    [providerGroups, currentModelSelection.instanceId, threadIdle],
  );
