...
it.layer(testLayer)("checkOpenCodeProviderStatus", (it) => {
  ...
  it.effect("closes the scoped local inventory server", () =>
    Effect.gen(function* () {
  ...
  it.effect("publishes OpenCode skills without their content", () =>
    Effect.gen(function* () {
      runtimeMock.state.inventory = {
        ...
        skills: [
          {
            ...
            location: "/Users/test/.agents/skills/review-code/SKILL.md",
      ...
      NodeAssert.equal("content" in snapshot.skills[0]!, false);
    }),
  );
