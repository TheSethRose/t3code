...
- Update the applicable downstream document during the same change or upstream sync when its facts or
...
- Runtime code and regression tests must live in their normal T3 paths and have byte-identical copies
  ...
  what makes restoration and review intentional during every upstream sync; an overlay copy without
